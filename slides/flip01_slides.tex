...
%
\title{Movie Review Sentiment Analysis (Kernels Only) }
\author{
Zhenshuai Xu
\\
\\JiLin University
...
%%==========================================================================================
%%
\begin{slide}{Movie Review Sentiment Analysis (Kernels Only)}
\begin{center}
...
\begin{itemize}
\item \textcolor{orange}{Sentiment analysis} on text data is required.
\item The dataset of this competition turned out to be different , in a sense regular Data Preparation/Cleansing and Feature harvesting didn't work.
\end{itemize}
}}
...
\begin{center}
	\begin{figure}[htbp]
		...
		\includegraphics[scale=0.9]{./pic/1.eps}
...
\begin{slide}[toc=,bm=]{Data Visualization Box Plot}
	\begin{center}
		\twotonebox{\rotatebox{50}{Aanlysis}}{\parbox{.86\textwidth}
			{The dataset is unbalanced, we need to take some measures to reduce the impact of data imbalance on the model.
				\begin{itemize}
					\item Receiver Operating Curve
					\item Clustering and Undersampling or Ensemble Learning
				\end{itemize}
		}}	
		\begin{figure}[htbp]			
			\includegraphics[scale=0.65]{./pic/2.eps}			
...
\begin{slide}[toc=,bm=]{Dataset Visualization}
	\twotonebox{\rotatebox{50}{Aanlysis}}{\parbox{.86\textwidth}
		{The data distribution of the training set and the test set are relatively consistent, and no additional processing is required.
	}}	
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.75]{./pic/3.eps}
...
\begin{slide}[toc=,bm=]{Id Visualization}
	\twotonebox{\rotatebox{50}{Aanlysis}}{\parbox{.86\textwidth}
		{The sentences generated by each paragraph are relatively uniform, without additional processing.
	}}	
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.75]{./pic/4.eps}
		\caption{Train VS Test}
	\end{figure}
...
\begin{slide}[toc=,bm=]{Data Clean}
	\twotonebox{\rotatebox{50}{Aanlysis}}{\parbox{.86\textwidth}
		{Here are couple of instances where punctutaions appeared to be predictive. So if we "cleanedup" the data in the name of data preparation some predictiveness will be lost.
	}}	
	\begin{figure}[htbp]
		\centering
		\includegraphics[scale=0.45]{./pic/6.eps}
		%	\caption{pick up longtitude }		
		\caption{Interesting Data}
	\end{figure}
...
\section{Result}
\begin{slide}[toc=,bm=]{Accuracy and Loss}
	\twotonebox{\rotatebox{50}{Aanlysis}}{\parbox{.86\textwidth}
		{Due to limited time and computing resources, we only iterated for 10 rounds. The results on the test set already meet our requirements.
	}}
	
	\begin{figure}[htbp]
		\centering
		
		\includegraphics[scale=0.5]{./pic/7.eps}
		\qquad	
		\includegraphics[scale=0.5]{./pic/8.eps}	
		\caption{Result}
	\end{figure}
...
\begin{slide}[toc=,bm=]{Accuracy and Loss}
	\twotonebox{\rotatebox{50}{Aanlysis}}{\parbox{.86\textwidth}
		{Pay attention to the values on the off-diagonal line.
	}}
	
	\begin{figure}[htbp]
		\centering
		
		\includegraphics[scale=0.75]{./pic/5.eps}	
