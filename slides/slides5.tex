...
\subsection{Average Fare Amount over Years }
\begin{slide}[toc=,bm=]{Average Fare Amount over Years}
	
	\begin{figure}[htbp]
		\centering
		
		\includegraphics[scale=0.5]{./fig/1.eps}		
		\caption{Average Fare Amount over Years}
	\end{figure}
...
\subsection{Average Fare Amount over Months }
\begin{slide}[toc=,bm=]{Average Fare Amount over Months}
	
	\begin{figure}[htbp]
		\centering
		
		\includegraphics[scale=0.5]{./fig/2.eps}		
		\caption{Average Fare Amount over Months}
	\end{figure}
...
\subsection{Average Fare Amount Day of Months }
\begin{slide}[toc=,bm=]{Average Fare Amount  Day of Months}
	
	\begin{figure}[htbp]
		\centering
		
		\includegraphics[scale=0.5]{./fig/3.eps}		
		\caption{Average Fare Amount  Day of Months}
	\end{figure}
...
\subsection{Average Fare Amount per hour }
\begin{slide}[toc=,bm=]{Average Fare Amount per hour}
	
	\begin{figure}[htbp]
		\centering
		
		\includegraphics[scale=0.5]{./fig/4.eps}		
		\caption{Average Fare Amount  per hour}
	\end{figure}
...
\section{Feature Select}
\subsection{Feature heatmap}
\begin{slide}[toc=,bm=]{Feature heatmap}
...
\subsection{Ten Best Feature}
\begin{slide}[toc=,bm=]{Ten Best Feature}
...
\begin{slide}[toc=,bm=]{Results}
	\begin{table}
		...
		\begin{tabular}{  c | c | c }
			\toprule
			\centering
			\texttt{Feature number}  & \texttt{Model}  & \texttt{RSME}\\
			\midrule
			{\{$N_1$\}}                           & $rf$   & $4.002$\\
			{\{$N_1$\}}                      & $lgb$  & $3.007$\\
			{\{$N_10$\}}                           & $rf$  & $2.987$ \\
